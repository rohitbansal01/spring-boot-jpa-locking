...
import com.spring.jpa.locking.MovieDTO;
import com.spring.jpa.locking.Movies;
import com.spring.jpa.locking.JPALockingApplication;
...
public class JPALockingApplicationTests {
	...
	/**
	 * Tests the situation, that there are two concurrent users working with a web
	 * application and both operating on the same data at the same time.
	 */
